...
| `0x1F7` | byte3 signed i8 | provisional `0.375 × raw + 57 °C` | **gearbox-oil temperature candidate**, with much more oil-like affine scaling than TCU chip temperature | ignition ON / running | **candidate only; not telemetry-allowlisted**. A zero-drop cold-start leg retained 2,027 exact samples across `04FE` 33–85 °C. The exact byte ranked 6 with full coverage, R² 0.99734, slope 0.37608, intercept 97.1015 raw counts, and 0.851-count fitted RMSE. The predeclared fixed formula independently achieved 0.863 °C RMSE, 0.135 °C absolute mean bias, and 1.0 °C p95 absolute error; retrospective direct scoring of the 72- and 45-minute blind legs also stayed at 0.839/0.883 °C RMSE and 1.0 °C p95 error. It nevertheless failed the frozen oil-versus-chip discriminator: chip-temperature R² was 0.98339, only 0.01395 lower instead of the required 0.10. An identical warm-up trajectory is not the next experiment. [candidate evidence](../projects/ecu_mapping/findings/promaster_2022/2026-07-29_tcm_oil_temperature_candidate.md) |
