...
| `0x1F7` | byte3 signed i8 | provisional `0.375 × raw + 57 °C` | **gearbox-oil temperature candidate**, distinguished from TCU chip temperature across three exact-linked drive legs | ignition ON / running | **candidate only; not telemetry-allowlisted**. Discovery R² 0.99584 with 0.791 raw-count RMSE, but precommitted 72-/45-minute carrier gates failed at R² 0.88605/0.86623 and the latter slope fell just outside its frozen range; requires a new broad-range independent cold-start challenge. [candidate evidence](../projects/ecu_mapping/findings/promaster_2022/2026-07-29_tcm_oil_temperature_candidate.md) |
