...
| `0x417` | bytes2–3 BE u16 | candidate `raw / 64 - 2 °C` | leading **gearbox-oil-temperature candidate** from TCM DID `04FE`; narrow 35–43 °C excitation and covariance with TCU chip temperature prevent telemetry promotion | ignition ON / running | bounded candidate, 169 samples, R² 0.946605 and about 0.525 °C centered residual after lag alignment; [TCM loaded-drive evidence](../projects/ecu_mapping/findings/promaster_2022/2026-07-27_tcm_plots_loaded_drive_mapping.md) |
